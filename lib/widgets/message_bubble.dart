...
class MessageBubble extends StatelessWidget {
  ...
  void _handleMessageTap(BuildContext context, String message) {
    final isLocationMessage = message.startsWith('Location:');
    if (isLocationMessage) {
      // Extract latitude and longitude from the message
      final locationParts = message.split(':')[1].trim().split(',');
